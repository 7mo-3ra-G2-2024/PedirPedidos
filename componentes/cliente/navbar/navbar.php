<nav class="navbar">
    <div class="navbar-container">
        ...
        <div class="navbar-links">
            <ul>
                <li><a href="https://kaseladevteam.000webhostapp.com">Inicio</a></li>
        ...
        <div class="navbar-auth">
            <a href="/PedirPedidos/componentes/login/registro.php" class="btn-register">Registrarse</a>
            <a href="/PedirPedidos/componentes/login/index.php" class="btn-login">Ingresar</a>
        </div>
    </div>
</nav>
