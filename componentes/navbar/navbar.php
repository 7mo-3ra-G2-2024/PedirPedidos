    ...
    <div class="navbar-container">
        <div class="navbar-title">
            <div class="navbar-logo">
                ...
                <a href="index_cliente.php">Tenes que pedirlo</a>
            </div>     
        </div>
        <div class="navbar-links">
            <ul>
                <li><a href="index_cliente.php">Inicio</a></li>
                <li><a href="componentes/productos/productos.php">Productos</a></li>
                <li><a href="componentes/contacto/contacto.php">Contacto</a></li>
            </ul>
        </div>
        <div class="navbar-auth">
            <a href="componentes/registros/registro.php" class="btn-register">Registrarse</a>
            <a href="componentes/login/login.php" class="btn-login">Ingresar</a>
        </div>
    </div>
</nav>
